        ...
        <div className='min-h-screen mt-20'>
            <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5">
                ...
                <div className="">
                    ...
                    <p className='text-sm mt-5'>This is demo project. You can sign in with email and password or google account.</p>
                </div>
                {/* right */}
                <div className="flex-1">
                    <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
                        <div>
                            ...
                            <TextInput placeholder='Email' type='email' id='email' onChange={handleForm}></TextInput>
                        </div>
                        <div>
                            <Label value='Your password'></Label>
                            <TextInput placeholder='**********' type='password' id='password' onChange={handleForm}></TextInput>
                        </div>
