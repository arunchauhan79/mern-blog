    ...
    return (
        <div className='p-3 max-w-3xl mx-auto min-h-screen'>
            ...
            <form className='flex flex-col gap-4'>
                    ...
                    <Button type='button' gradientDuoTone={'purpleToBlue'} outline size='sm' onClick={handleUploadImage} disabled={imageUploadProgress}>
                        {
                            imageUploadProgress ? (
                                <>
                                    <CircularProgressbar className={'w-10 h-10'} value={imageUploadProgress} text={`${imageUploadProgress || 0}%`}
                                        strokeWidth={5}
                                        styles={{
                                            root: {
                                                width: '100%',
                ...
                {
                    imageUploadError && <Alert className='mt-2' color='failure'>{imageUploadError} </Alert>
                }
                {
