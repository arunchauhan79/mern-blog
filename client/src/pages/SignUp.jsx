                ...
                <div className="flex-1">
                    <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
                        <div>
                            ...
                            <TextInput placeholder='Username' type='text' id='username' onChange={handleForm}></TextInput>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <TextInput placeholder='Password' type='password' id='password' onChange={handleForm}></TextInput>
                        </div>
